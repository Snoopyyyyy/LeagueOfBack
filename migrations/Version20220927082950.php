 ...
 */
final class Version20220927082950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, summoner_id INT DEFAULT NULL, date DATE NOT NULL, duree TIME NOT NULL, win TINYINT(1) NOT NULL, INDEX IDX_232B318CBC01C675 (summoner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inhibiter_kill (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, assistance LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', bounty INT NOT NULL, player_id INT NOT NULL, position_x INT NOT NULL, position_y INT NOT NULL, team_id INT NOT NULL, timestamp TIME NOT NULL, INDEX IDX_C600F34E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, item_id INT NOT NULL, player_id INT NOT NULL, timestamp TIME NOT NULL, gold_gain INT NOT NULL, before_id INT NOT NULL, after_id INT NOT NULL, INDEX IDX_1F1B251EE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `kill` (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, assistance LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', bounty INT NOT NULL, killer_id INT NOT NULL, killer_streak INT NOT NULL, position_x INT NOT NULL, position_y INT NOT NULL, shutdown_bounty INT NOT NULL, timestamp TIME NOT NULL, victime_id INT NOT NULL, INDEX IDX_7295669E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objectif_kill (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, assistance LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', bounty INT NOT NULL, player_id INT NOT NULL, position_x INT NOT NULL, position_y INT NOT NULL, team_id INT NOT NULL, timestamp TIME NOT NULL, monster_type VARCHAR(255) NOT NULL, sub_monster_type VARCHAR(255) NOT NULL, INDEX IDX_7672ACE3E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plate (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, player_id INT NOT NULL, position_x INT NOT NULL, position_y INT NOT NULL, team_id INT NOT NULL, timestamp TIME NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_719ED75BE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tower_kill (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, tower_type VARCHAR(255) NOT NULL, assistance LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', bounty INT NOT NULL, player_id INT NOT NULL, position_x INT NOT NULL, position_y INT NOT NULL, team_id INT NOT NULL, timestamp TIME NOT NULL, INDEX IDX_3A2D858FE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ward (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, player_id INT NOT NULL, timestamp TIME NOT NULL, type VARCHAR(255) NOT NULL, ward_type VARCHAR(255) NOT NULL, INDEX IDX_C96F581BE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
